...
public class IncomeDialog extends JDialog {
	...
	private JComboBox comboOrigin = null;
	...
	private JLabel labelReceived = null;
	private JComboBox comboReceived = null;
	/**
	 * @param owner
	 */
	public IncomeDialog(Frame owner) {
		super(owner);
		initialize();
	}
	...
	private JPanel getPanelContent() {
		if (panelContent == null) {
			...
			labelOrigin.setText("Payment Origin");
			...
			panelContent.add(labelOrigin, gridBagConstraints6);
			panelContent.add(getComboOrigin(), gridBagConstraints7);
			...
			panelContent.add(labelReceived, gridBagConstraints12);
			panelContent.add(getComboReceived(), gridBagConstraints13);
		}
		return panelContent;
	}
	...
	/**
	 * This method initializes comboOrigin	
	 * 	
	 * @return javax.swing.JComboBox	
	 */
	private JComboBox getComboOrigin() {
		if (comboOrigin == null) {
	...
	/**
	 * This method initializes comboReceived	
	 * 	
	 * @return javax.swing.JComboBox	
	 */
	private JComboBox getComboReceived() {
		if (comboReceived == null) {
			comboReceived = new JComboBox();
		}
		return comboReceived;
	}
